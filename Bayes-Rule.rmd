...
#### Math
(Odds Correct for Precipitation) * (Days there is Precipitation) + (Odds Correct for Non-Precipitation) * (Days there is No Precipitation)
...
#### Math
Precipiation Prediction = (115/365) * 0.93 + (250/365) * 0.13
